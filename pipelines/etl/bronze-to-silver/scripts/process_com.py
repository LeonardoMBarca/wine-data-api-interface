...
LOG_FILE = os.path.abspath(os.path.join("pipelines", "etl", "bronze-to-silver", "logs", "etl_com_silver.log"))
...
def main():
    ...
    """
    csv_path =  fr"{os.path.join("data", "bronze-layer", "Comercio.csv")}"
    silver_path = "data/silver-layer"
    output_file = os.path.join(silver_path, f"comercio.csv")
