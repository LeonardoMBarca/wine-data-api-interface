document.addEventListener('DOMContentLoaded', () => {
    const dados = window.dadosExportacao;
    const colunas = window.colunasExportacao;
        ...
        graficoBarras = new Chart(ctxBarras, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: { display: true, text: 'Exportação por Ano (Kg)' }
                }
            }
        });
        ...
        graficoPizza = new Chart(ctxPizza, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: categorias.map((_, i) => `hsl(${i * 50 % 360}, 70%, 60%)`)
                }]
            },
            options: {
                responsive: true,
